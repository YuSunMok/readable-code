...
public class StudyCafePassMachine {
    ...
    private Optional<StudyCafeLockerPass> selectLockerPass(StudyCafePass selectedPass) {
        ...
        StudyCafeLockerPass lockerPssCandidate = findLockerPassCandidateBy(selectedPass);

        if (lockerPssCandidate != null) {
            outputHandler.askLockerPass(lockerPssCandidate);
            boolean isLockerSelected = inputHandler.getLockerSelection();

            if (isLockerSelected) {
                return Optional.of(lockerPssCandidate);
            }
        }
